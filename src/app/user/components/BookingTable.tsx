    ...
    <div>
      ...
      <div className="space-y-4">
        {Array.isArray(bookings) && bookings.map((item: any, index: number) => (
          <div 
            key={item.id} 
            className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 p-6 flex items-center justify-between border border-gray-100 hover:border-blue-200 group"
