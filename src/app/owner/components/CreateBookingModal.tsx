...
export default function CreateBookingModal({ onSuccess }: CreateBookingModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await bookingService.ownerCreateBooking(payload);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] p-0 overflow-hidden">
        <div className="bg-gradient-to-r from-green-500 to-blue-600 p-8 pb-12">
          <DialogHeader>
            <DialogTitle className="text-3xl font-bold text-white mb-2">Create Booking</DialogTitle>
            <p className="text-green-100 text-sm">Fill in the details to reserve your meeting room</p>
          </DialogHeader>
        </div>
          ...
          <div className="grid gap-6">
            ...
            <div className="flex gap-4 mt-4">
              <button 
                ...
                disabled={isLoading}
                className="flex-1 bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold py-3.5 rounded-xl hover:from-green-600 hover:to-blue-700 transition-all duration-200 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
              >
