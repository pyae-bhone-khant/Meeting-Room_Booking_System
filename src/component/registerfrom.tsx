...
export default function RegisterForm() {
  ...
  const onSubmit = async (values: z.infer<typeof registerSchema>) => {
    // 🚀 မင်းရဲ့ Better-Auth သို့မဟုတ် Custom API Register Logic ကို ဒီမှာ ရေးပါ
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <FormControl>
                    <div className="relative group">
                      ...
                      <Input 
                        ...
                        className="pl-12 bg-gray-50 border-gray-300 text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-emerald-500 transition-all" 
                        {...field} 
                      />
                    </div>
                  </FormControl>
                  ...
                  <FormControl>
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        placeholder="••••••••"
                        className="pl-12 pr-12 bg-gray-50 border-gray-300 text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-emerald-500 transition-all"
                        {...field}
                      />
                      <button
                        type="button"
            ...
            <Button 
              type="submit" 
              className="w-full font-semibold mt-4 bg-emerald-600 text-white hover:bg-emerald-700 shadow-lg hover:shadow-xl transition-all" 
