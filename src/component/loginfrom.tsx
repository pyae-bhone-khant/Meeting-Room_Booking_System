   ...
   <div className="flex flex-col md:flex-row gap-6 w-full max-w-4xl mx-auto items-start justify-center p-4">
      ...
      <Card className="bg-white border border-gray-200 shadow-xl w-full md:max-w-[460px] shrink-0">
        ...
        <CardFooter className="flex justify-center border-t border-gray-200 p-6 mt-4">
          <p className="text-sm text-gray-600">
            ...
            <a href="/register" className="text-indigo-600 font-medium hover:underline transition-colors">
              Register
            </a>
          </p>
        </CardFooter>
      ...
      <Card className="bg-gray-50 border-dashed border-gray-300 w-full shadow-sm rounded-xl">
        ...
        <CardContent className="p-5 pt-0 grid grid-cols-1 gap-3 text-xs">
          ...
          >
            <div>
              <span className="font-bold text-red-600 mr-2 group-hover:text-red-700 transition-colors">[ADMIN]</span>
              <span className="text-gray-700 group-hover:text-gray-900 transition-colors">admin@gmail.com</span>
            </div>
            <code className="bg-gray-100 px-2 py-1 rounded text-[10px] text-gray-600 group-hover:text-gray-700 transition-colors self-end sm:self-auto">password123</code>
          </button>
          ...
          >
            <div>
              <span className="font-bold text-blue-600 mr-2 group-hover:text-blue-700 transition-colors">[OWNER]</span>
              <span className="text-gray-700 group-hover:text-gray-900 transition-colors">owner@gmail.com</span>
            </div>
            <code className="bg-gray-100 px-2 py-1 rounded text-[10px] text-gray-600 group-hover:text-gray-700 transition-colors self-end sm:self-auto">password123</code>
          </button>
          ...
          >
            <div>
              <span className="font-bold text-green-600 mr-2 group-hover:text-green-700 transition-colors">[USER]</span>
              <span className="text-gray-700 group-hover:text-gray-900 transition-colors">user@gmail.com</span>
            </div>
            <code className="bg-gray-100 px-2 py-1 rounded text-[10px] text-gray-600 group-hover:text-gray-700 transition-colors self-end sm:self-auto">password123</code>
          </button>
